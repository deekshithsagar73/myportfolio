...
// function Model() {
//   const { scene, animations } = useGLTF('/src/assets/robot_playground/scene.gltf');
//   const mixer = useRef();
...
//   return <primitive object={scene} scale={6} position={[0, -1.5, 0]} />;
// }
...
//     >
//       {/* Reduced ambient light for softer lighting */}
//       <ambientLight intensity={0.3} /> 

//       {/* Hemisphere light to provide soft, natural lighting from above and below */}
//       <hemisphereLight 
...
//       {/* Directional light for casting shadows, with reduced intensity */}
//       <directionalLight 
//         position={[0, 10, 5]} 
//         intensity={0.8} 
//         castShadow={true}
