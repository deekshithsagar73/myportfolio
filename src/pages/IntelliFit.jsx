...
const IntelliFit = () => {
  const project = {
    ...
    tech: "OpenCV, TensorFlow, Docker, Computer Vision, Pose Estimation, Real-time Processing",
    ...
    features: [
      ...
      "Exercise counting and form analysis",
      "Docker containerization for scalable deployment",
      "Computer vision-based fitness tracking",
      "Real-time exercise detection and monitoring",
      "Form correction and feedback system",
      "Multi-exercise support and recognition",
      "Web-based interface for easy access"
    ],
    results: [
      { metric: "Real-time", description: "Exercise detection" },
      { metric: "Pose Estimation", description: "Form analysis" },
      { metric: "Docker", description: "Scalable deployment" },
      { metric: "OpenCV", description: "Computer vision" }
    ],
    methodology: "Built using OpenCV for computer vision processing and TensorFlow for pose estimation models. Implements real-time exercise detection with form analysis capabilities. Features Docker containerization for easy deployment and scalability."
  };
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        >
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            IntelliFit Exercise Detection System
          </h1>
          <p className="text-lg md:text-xl text-gray-300 max-w-4xl mx-auto">
            AI-powered fitness tracking platform with real-time pose estimation and exercise analysis
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-tertiary p-8 rounded-2xl">
            ...
            <div className="flex flex-wrap gap-2">
              {["OpenCV", "TensorFlow", "Docker", "Computer Vision", "Pose Estimation", "Real-time Processing"].map((tech) => (
            ...
            {[
              {
                ...
                description: "OpenCV integration for real-time video processing and pose detection"
              },
              {
                title: "AI Models",
                description: "TensorFlow-based pose estimation models for exercise recognition"
              },
              {
                title: "Deployment",
                description: "Docker containerization for scalable and portable deployment"
              }
            ].map((component, index) => (
              <motion.div
                key={index}
