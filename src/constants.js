...
export const skills = [
  ...
  "LangChain", "AI Agents", "MCP Protocol", "FastAPI", "Agentic AI", "VAE",
  "ResNet", "Ensemble Models", "Anomaly Detection", "Deepfake Detection"
];
...
export const projects = [
  {
    ...
    tech: "PyTorch, LangChain, MCP Protocol, FastAPI",
    description: "An autonomous AI-powered research platform that conducts comprehensive research, synthesizes knowledge, and generates insights. Features 5 specialized AI agents working in coordination, achieving 10-15x faster research with 92% accuracy. Demonstrates cutting-edge 2025 research topics including Quantum AI, Neuromorphic Computing, and Climate AI solutions.",
    date: "Oct 2024",
    source: "https://github.com/deekshithsagar73/agentic-research-assistant",
    hasGitHub: true,
    tags: [
  ...
  },
  {
    ...
    description: "Advanced deep learning system to detect manipulated media using ensemble of ResNet architectures. Achieves 94% accuracy in identifying deepfakes across multiple video formats. Features temporal consistency analysis, optical flow detection, and real-time processing capabilities with Flask API deployment.",
    date: "Sep 2024",
    source: "https://github.com/deekshithsagar73/deepfake-detection",
    hasGitHub: true,
    tags: [
      { name: "PyTorch", color: "text-red-400" },
      { name: "ResNet", color: "text-blue-400" },
      { name: "Computer Vision", color: "text-green-400" },
    ],
  },
  {
    title: "Intelligent Anomaly Detection System",
    tech: "TensorFlow, VAE, Time Series, IoT Analytics",
    description: "Automated defect detection system for manufacturing using Variational Autoencoders (VAE). Reduced manual inspection time by 75% and improved defect detection accuracy to 92%. Integrated with IoT sensors for real-time monitoring, featuring sliding window analysis and NAB dataset integration.",
    date: "Aug 2024",
    source: "https://github.com/deekshithsagar73/anomaly-detection",
    hasGitHub: true,
    tags: [
      { name: "TensorFlow", color: "text-orange-400" },
      { name: "VAE", color: "text-purple-400" },
      { name: "IoT", color: "text-green-400" },
    ],
  },
  {
  ...
  },
  {
    ...
    hasGitHub: false,
    tags: [
      { name: "OpenCV", color: "text-blue-400" },
  ...
  },
  {
    ...
    date: "July 2025",
    source: "https://github.com/deekshithsagar73/integrity-crm-portal",
    hasGitHub: true,
    live: "https://theintegritycompanyinc.com",
    tags: [
      { name: "React", color: "text-blue-400" },
      { name: "Django", color: "text-green-400" },
      { name: "Salesforce", color: "text-blue-300" },
  ...
  },
  {
    ...
    tech: "Python, PyTorch, BERT, Graph Neural Networks, Code Analysis",
    description: "IEEE Conference Publication on advanced code vulnerability detection using GraphCodeBERT and Graph Attention Networks. Developed novel approach combining transformer-based code understanding with graph neural networks for enhanced security analysis.",
    date: "Dec 2024",
    source: "https://github.com/deekshithsagar73/graphcodebert-vulnerability-detection",
    hasGitHub: true,
    publication: "IEEE Conference Publication",
    tags: [
      { name: "Python", color: "text-yellow-400" },
      { name: "PyTorch", color: "text-red-400" },
      { name: "BERT", color: "text-blue-400" },
      { name: "Graph Neural Networks", color: "text-purple-400" },
    ],
  },
];
